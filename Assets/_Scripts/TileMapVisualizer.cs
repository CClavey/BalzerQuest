...
public class TileMapVisualizer : MonoBehaviour
{
    ...
    [SerializeField]
    private TileBase wallInnerCornerTopLeft;

    [SerializeField]
    private TileBase wallInnerCornerTopRight;
    ...
    internal void PaintSingleBasicWall(Vector2Int postion, string binaryType)
    {
        ...
        if (tile!=null)
            PaintSingleTile(wallTilemap, tile, postion);
    }
